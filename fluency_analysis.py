...
def analyze_fluency(audio_file):
    wav_num, _ = divide_audio(audio_file, "./fluency_analysis/seg_result", 5000, 3000) #CHANGE PATH TO: "./tone_analysis/seg_result"
    ...
    return round(score,2)*10, expression_matrix, expression_weights
