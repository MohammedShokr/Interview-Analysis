...
def load_view(comp_id):
    ...
    try:
        ...
        st.info("Your company doesn't have any analysis records to show!")
    ...
    with st.container():
        ...
        with col4_1:
            ...
            if cand1:
                if cand1_analysis_df.empty: col4_2.info("There are no analysis records for the first candidate!")
            ...
            if cand2:
                if cand2_analysis_df.empty:col4_2.info("There are no analysis records for the second candidate!")
    ...
    with st.expander("Individual Report"):
        ...
        if candindate_ID:
            if not cand_analysis_df.empty:
                ...
                st.error("There is no analysis data for this candidate!")
